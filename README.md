...
- No canto inferior esquerdo deve aparecer `mural 20260617-live` — confirma que está na versão certa
- No topo deve aparecer uma **barra verde** `DEV · project-root` — confirma servidor correto
- Rode `npm run dev:doctor` se algo não atualizar
